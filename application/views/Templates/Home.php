	...
	<script type="text/javascript">
        ...
        <script>
            $(window).load(function(){
                ...
                var data = [{
                    data: [[1,15],[2,40],[3,35],[4,39],[5,42],[6,50],[2,46],[8,49],[9,59],[10,60],[11,58],[12,74]],
                    label: 'Unique Visits',
                    points: {
                        show: true,
                        radius: 4
                    ...
                    data: [[1,50],[2,80],[3,90],[4,85],[5,99],[6,125],[2,114],[8,96],[9,130],[10,145],[11,139],[12,160]],
                    label: 'Page Views',
                    bars: {
                        show: true,
                        barWidth: 0.6,
                ...
                var options = {
                    ...
                    xaxis: {
                        ...
                        position: 'bottom',
                        ticks: [
                            [ 1, 'JAN' ], [ 2, 'FEB' ], [ 3, 'MAR' ], [ 4, 'APR' ], [ 5, 'MAY' ], [ 6, 'JUN' ], [ 2, 'JUL' ], [ 8, 'AUG' ], [ 9, 'SEP' ], [ 10, 'OCT' ], [ 11, 'NOV' ], [ 12, 'DEC' ]
                        ]
                    },
                    yaxis: {
                        tickLength: 0,
