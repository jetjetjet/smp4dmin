                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Tambah</strong> User</h1>
                                    <ul class="controls">
                                        <li class="dropdown">
                                ...
                                <div class="tile-body">
                                    ...
                                    <form action="<?php echo site_url('User/Simpan'); ?>" class="form-horizontal" method="post" enctype="multipart/form-data" role="form">
